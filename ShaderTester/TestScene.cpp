...
bool TestScene::init()
{
    ...
    phongShader = new Shader("Resources/Shaders/BasicMorph");
    phongShader->setName("Light and Morph");

    basicMorphNoLights = new Shader("Resources/Shaders/BasicMorph", "Resources/Shaders/BasicMorphNoLights");
    basicMorphNoLights->setName("Morph");
    
    manyLights = new Shader("Resources/Shaders/BasicMorph", "Resources/Shaders/FragmentLights");
