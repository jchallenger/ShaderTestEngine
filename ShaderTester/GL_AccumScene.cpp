...
TestScene1::TestScene1(void) : Scene()
{
}
...
bool TestScene1::init()
{
    ...
    lightSwitch->setColour(0,1,1,0.7);
    ...
    basicMorphNoLights = new Shader("Resources/Shaders/Basic", "Resources/Shaders/BasicMorphNoLights");
    basicMorphNoLights->setName("Morph");
    
    manyLights = new Shader("Resources/Shaders/Basic", "Resources/Shaders/FragmentLights");
    manyLights->setName("ManyLights");

    currentShader = manyLights;
  ...
  //temp->texture = TextureUtils::loadCubeEnvMap("Resources/Images/mars");
    ...
    //temp->texture = TextureUtils::loadTexture("Resources/Images/Sphere_AO.jpg");
    ...
    temp->texture = TextureUtils::loadTexture("Resources/Images/sky.jpg");
    //temp->texture = TextureUtils::loadTexture("Resources/Images/Room_AO.jpg");
    temp->setStartPosition(0,0,0);
    temp->setPosition(0,0,0);
    temp->textureType = DIF_MAP;
    temp->setScene(this);
    ...
    //temp->texture = TextureUtils::loadTexture("Resources/Images/AlienShip_AO.jpg");
